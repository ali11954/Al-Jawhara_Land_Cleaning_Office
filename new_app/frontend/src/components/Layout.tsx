...
const navItems = [
  { path: '/', label: 'الرئيسية', icon: Home, roles: ['admin', 'owner', 'supervisor', 'accountant', 'viewer'] },
  { path: '/employees', label: 'الموظفين', icon: Users, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/attendance', label: 'الحضور', icon: CalendarCheck, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/companies', label: 'الشركات', icon: Building2, roles: ['admin', 'owner', 'supervisor', 'accountant'] },
  { path: '/contracts', label: 'العقود', icon: FileCheck, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/invoices', label: 'الفواتير', icon: FileText, roles: ['admin', 'owner', 'supervisor', 'accountant'] },
  { path: '/evaluations', label: 'التقييمات', icon: Star, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/work-plans', label: 'خطط العمل', icon: ClipboardList, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/salaries', label: 'الرواتب', icon: Coins, roles: ['admin', 'owner', 'accountant'] },
  { path: '/financial', label: 'المالية', icon: DollarSign, roles: ['admin', 'owner', 'accountant'] },
  { path: '/accounts', label: 'الحسابات', icon: BookOpen, roles: ['admin', 'owner', 'accountant'] },
  { path: '/suppliers', label: 'الموردين', icon: Truck, roles: ['admin', 'owner', 'accountant'] },
  { path: '/supplier-invoices', label: 'فواتير الموردين', icon: FileText, roles: ['admin', 'owner', 'accountant'] },
  { path: '/periods', label: 'الفترات المالية', icon: Calendar, roles: ['admin', 'owner', 'accountant'] },
  { path: '/leaves', label: 'الإجازات', icon: Clock, roles: ['admin', 'owner', 'supervisor'] },
  { path: '/reports', label: 'التقارير', icon: BarChart3, roles: ['admin', 'owner', 'supervisor', 'accountant'] },
  { path: '/users', label: 'المستخدمين', icon: UserCog, roles: ['admin', 'owner'] },
  { path: '/profile', label: 'الملف الشخصي', icon: User, roles: ['admin', 'owner', 'supervisor', 'accountant', 'viewer', 'employee'] },

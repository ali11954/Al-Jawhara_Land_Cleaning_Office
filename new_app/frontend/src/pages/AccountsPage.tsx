...
function AccountStatement() {
  ...
  const printStatement = () => {
    ...
    win.document.write(`<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><title>كشف حساب - ${statement.account.name}</title>
      ...
      .header{text-align:center;border-bottom:2px solid #3b82f6;padding-bottom:15px;margin-bottom:15px}
      ...
      th{background:#3b82f6;color:white;padding:10px;text-align:right;font-size:12px}
      td{padding:8px;font-size:13px;border-bottom:1px solid #eee}
      .total-row{background:#eff6ff;font-weight:bold;border-top:2px solid #3b82f6}
      .footer{margin-top:30px;text-align:center;color:#6b7280;font-size:11px}
      @media print{body{padding:15px}}</style></head><body>
      <div class="header"><h1>ارض الجوهرة لخدمات النظافة</h1><h2>كشف حساب</h2></div>
      <div class="info">
      ...
      <div class="footer">ارض الجوهرة لخدمات النظافة - كشف حساب</div>

...
export default function InvoicesPage() {
  ...
  const handlePrint = () => {
    ...
    win.document.write(`
      ...
      <style>
        ...
        th { background: #3b82f6; color: white; padding: 12px; text-align: right; font-size: 14px; }
  ...
  const statusData = [
    { name: 'مدفوعة', value: invoices.filter(i => (i.amount || 0) <= (i.paid_amount || 0)).length, color: '#3b82f6' },
    ...
    <div className="space-y-6">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={[{ name: 'الإجمالي', value: total }, { name: 'المدفوع', value: paid }, { name: 'المتبقي', value: unpaid }]}>
                ...
                <Bar dataKey="value" radius={[6, 6, 0, 0]}>
                  {[{ fill: '#3b82f6' }, { fill: '#3b82f6' }, { fill: '#ef4444' }].map((s, i) => <Cell key={i} fill={s.fill} />)}
                </Bar>
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
      ...
      <Modal open={!!previewInvoice} onClose={() => setPreviewInvoice(null)} title="معاينة الفاتورة" size="lg">
        {previewInvoice && (
          <div>
            <div ref={printRef}>
              <div className="header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '3px solid #3b82f6', paddingBottom: '20px', marginBottom: '30px' }}>
                <div>
                  <div style={{ fontSize: '22px', fontWeight: 'bold', color: '#3b82f6' }}>ارض الجوهرة لخدمات النظافة</div>
                  <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>EARTH AL-JAWHARA FOR CLEANING SERVICES</div>
                </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
                ...
                <tbody>
                  ...
                  <tr style={{ borderBottom: '1px solid #e5e7eb', background: '#f0fdf4' }}>
                    ...
                    <td style={{ padding: '12px', fontSize: '14px', fontWeight: 'bold', color: '#3b82f6' }}>{formatNum(previewInvoice.paid_amount || 0)}</td>
                  </tr>
              ...
              <div style={{ marginTop: '40px', paddingTop: '20px', borderTop: '2px solid #e5e7eb', textAlign: 'center', color: '#6b7280', fontSize: '11px' }}>
                <p>ارض الجوهرة لخدمات النظافة - فاتورة ضريبية</p>
                <p style={{ marginTop: '4px' }}>EARTH AL-JAWHARA FOR CLEANING SERVICES</p>
              </div>
            </div>

...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const token = res.data.token || res.data.data?.token || 'session';
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary-50 to-primary-100 px-8 py-10 text-center border-b border-gray-100">
            <img src="/logo.png" alt="ارض الجوهرة" className="w-24 h-24 object-contain mx-auto mb-4 drop-shadow-lg" />
            <h1 className="text-2xl font-bold text-primary-800">ارض الجوهرة</h1>
            <p className="text-sm text-gray-500 mt-1">لخدمات النظافة</p>

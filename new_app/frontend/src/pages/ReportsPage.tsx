              ...
              <CardContent className="p-6">
                ...
                <ResponsiveContainer width="100%" height={250}>
                  <AreaChart data={financial?.monthly || []}>
                    ...
                    <Area type="monotone" dataKey="income" stroke="#3b82f6" fill="#3b82f633" name="الإيرادات" />
                  ...
                  <CardContent className="p-4">
                    ...
                    <ResponsiveContainer width="100%" height={200}>
                      <BarChart data={comp.daily || []}>
                        ...
                        <Tooltip />
                        <Bar dataKey="present" fill="#3b82f6" name="حاضر" radius={[3, 3, 0, 0]} />
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <AreaChart data={(evaluations.monthly_trend || []).reverse()}>
                      ...
                      <Legend />
                      <Area type="monotone" dataKey="avg" name="متوسط الدرجة" stroke="#3b82f6" fill="#3b82f620" strokeWidth={2} />
